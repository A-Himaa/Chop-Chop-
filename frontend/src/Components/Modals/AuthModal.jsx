...
// Ant Design orange theme config
const themeConfig = {
  token: {
  ...
  return (
    <ConfigProvider theme={themeConfig}>
      <Modal
        ...
        style={modalStyle}
      >
        <Tabs activeKey={activeTab} onChange={setActiveTab} centered style={tabsStyle}>
              ...
              >
                ...
                <div style={footerTextStyle}>
                  <Text type="secondary">
                    ...
                    <Button type="link" onClick={() => setActiveTab("signup")} style={{ padding: 0 }}>
                      Sign up now
                    </Button>
                  </Text>
                </div>
              ...
              >
                ...
                <Form.Item name="file" valuePropName="fileList" getValueFromEvent={normFile}>
                  ...
                  >
                    ...
                    <p className="ant-upload-hint">Click or drag an image to this area</p>
                  </Upload.Dragger>
                </Form.Item>
                ...
                <div style={footerTextStyle}>
                  <Text type="secondary">
                    ...
                    <Button type="link" onClick={() => setActiveTab("signin")} style={{ padding: 0 }}>
                      Sign in
                    </Button>
                  </Text>
                </div>
