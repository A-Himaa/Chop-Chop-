  ...
  return (
    <div className="center" style={{ 
      ...
      >
        ...
        >
          <img style={{ maxHeight: 60 }} src="/assets/chopchop.svg" alt="logo" />
      ...
      <div style={{ 
        ...
        >
          <TabPane tab="Social Engagement" key="1">
            <MyPost />
            <div>
              {snap.posts.map((post) => {
          ...
          <TabPane tab="Learning Progress Tracking" key="2">
            <LearningProgressBox />
            <div>
          ...
          <TabPane tab="Skill Sharing" key="3">
            <CreaetSkillShareBox />
